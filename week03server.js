...
/*Subtract with 'POST' as an end point */

const subtract = (n1, n2) => {
  return n1 - n2;
}

app.use(express.json()); // Required for parsing JSON data from request body
...
/* Division with 'DELETE' as an end point */
